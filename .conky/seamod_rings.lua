...
gauge = {
{
    ...
    hand_fg_colour=0x00CCFF,       hand_fg_alpha=1.0,
    txt_radius=64,
    txt_weight=0,                  txt_size=9.0,
    txt_fg_colour=0x00CCFF,        txt_fg_alpha=1.0,
...
{
    name='fs_used_perc',           arg='/mount/sda2',                     max_value=100,
    x=70,                          y=470,
    graph_radius=54,
    graph_thickness=7,
    graph_start_angle=180,
...
},
{
    ...
    graph_bg_colour=0xffffff,      graph_bg_alpha=0.1,
    graph_fg_colour=0xFFFFFF,      graph_fg_alpha=0.3,
    hand_fg_colour=0x00CCFF,       hand_fg_alpha=0,
    txt_radius=64,
    txt_weight=0,                  txt_size=9.0,
    txt_fg_colour=0x00CCFF,        txt_fg_alpha=1.0,
    graduation_radius=28,
